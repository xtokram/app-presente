...
def professor():
    ...
    if request.method == 'POST':
        ...
        try:
            logging.info(f'CHAMADA_REGISTRADA: chamada da turma {id_turma} registrada pelo usuario {usuario_atual}.')
    ...
    if request.method == 'PUT':
        ...
        encerramento = data.get('encerramento', 'NOT_FOUND')
        try:
            logging.info(f'CHAMADA_EDITADA:Chamada da turma {id_turma} editada pelo usuario {usuario_atual}.')
    ...
    if request.method == 'DELETE':
        ...
        try:
            logging.info(f'CHAMADA_DELETADA: {id_chamada} deletada deletada pelo usuario {usuario_atual}.')
...
def fechar_chamada():
    ...
    id_chamada = request.args.get('id')
    try:
        logging.error(f'CHAMADA_FECHADA: Chamada com id {id_chamada} fechada pelo usuario {usuario_atual}')
...
def updateAll():
    ...
    try:
        logging.error(f'CHAMADA_FECHADA_ALL: Todas as chamadas fechada pelo usuario {usuario_atual}')
